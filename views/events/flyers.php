...
<?php if ($event->flyer_front->id || $event->flyer_back->id): ?>
	<?php echo $event->flyer_front->id ? HTML::image($event->flyer_front->get_url('normal'), array('title' => __('Flyer, front'), 'width' => '100%')) : '' ?>
	<?php echo $event->flyer_back->id  ? HTML::image($event->flyer_back->get_url('normal'),  array('title' => __('Flyer, back'),  'width' => '100%')) : '' ?>
