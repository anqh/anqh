	...
	<li class="unit size1of4">
		<div class="thumb">
			<?php echo HTML::anchor(
				...
				array('title' => HTML::chars($image->description))) ?>
		</div>
		<?php echo HTML::icon_value(array(':comments' => $image->num_comments), ':comments comment', ':comments comments', 'posts') ?>
		<?php echo HTML::icon_value(array(':views' => $image->num_views), ':views view', ':views views', 'views') ?>
	</li>
